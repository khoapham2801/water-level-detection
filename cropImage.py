...
class MousePositionTracker(tk.Frame):
    ...
    def _update(self, event):
        ...
        self.canvas.coords(self.lines[0], event.x,
                           0, event.x, self.canv_height)
...
class SelectionObject:
    ...
    def __init__(self, canvas, select_opts):
        ...
        # Avoid modifying passed argument.
        select_opts1 = self.select_opts1.copy()
        select_opts1.update(state=tk.HIDDEN)  # Hide initially.
        # Separate options for area inside rectanglar selection.
        select_opts2 = dict(dash=(2, 2), fill='',
                            outline='white', state=tk.HIDDEN)
...
class CropImageFrame(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        path = "F:/vinAI/water-level/data/frames/DongHoi_7/frame0.jpg"
