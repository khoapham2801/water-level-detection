...
threeLinesHeight = 12
classMap = {0: 'ruler'}
pattern = EPattern('F:/vinAI/water-level/data/pattern1.jpg')
# new_detector = Detector_Yolov4("models/", classMap)
# img1 = cv2.imread("F:/vinAI/water-level/data/frames/vid1/frame115218.jpg")
...
# res, ges = new_detector.detect(img3)
...
# Detect three line
result, threeLinesHeightPixel = pattern.detect(img3)
# Bug: EPattern line 28: check lai phan resize.
# Calculate water level
print(threeLinesHeightPixel)
rulerHeightFloat = img3.shape[0] * \
    (threeLinesHeight / threeLinesHeightPixel)
# waterLevel = round(rulerHeight - rulerHeightFloat + rulerFootHeight, 3)
print(rulerHeightFloat)
# print(res[0][1])
cv2.imwrite("F:/vinAI/water-level/data/result.jpg", result)
# cv2.imshow('ges', ges)
# cv2.waitKey(0)
